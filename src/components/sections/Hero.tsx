...
export const Hero: React.FC = () => {
  ...
  return (
    <SectionWrapper
      variant="dark"
      className="pt-24 pb-16 md:pt-40 md:pb-32 relative overflow-hidden"
    >
        ...
        <div className="max-w-4xl">
          ...
          <div className="space-y-9 md:space-y-10 text-left">
            <div className="space-y-3.5 md:space-y-4">
              <p className="text-founderin-dark font-acumin-black tracking-tight uppercase text-[1.23rem] md:text-[1.375rem] leading-[1.1]">
                FOUNDER-TO-MARKET STUDIO
              </p>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-acumin-black tracking-tight leading-[1.1] text-founderin-dark relative z-10">
                We turn great founders in Japan into companies the world can{" "}
                <br className="md:hidden" />
                <span className="text-white md:text-founderin-mint transition-all duration-500 ease-in-out inline-block min-w-[10ch] whitespace-nowrap">
                  {words[wordIndex]}
                </span>
              </h1>
            </div>
            ...
            <div className="space-y-6 text-lg md:text-xl text-founderin-dark/80 max-w-2xl font-acumin-extra-light leading-relaxed">
              <p className="text-founderin-dark md:text-founderin-dark/80 text-[1.32rem] md:text-[1.8rem] font-semibold md:font-bold italic tracking-tight md:whitespace-nowrap relative z-10">
                <span className="md:hidden">
                  Private founding work for builders & founders going global
                </span>
                <span className="hidden md:inline font-bold">
                  Private founding work for builders and founders going global
                </span>
              </p>
            </div>
