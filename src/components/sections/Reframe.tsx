  ...
  return (
    <SectionWrapper variant="dark" className="py-16 md:py-24 text-center">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-founderin-dark text-[1.34rem] md:text-[1.58rem] font-semibold md:font-bold italic font-acumin-extra-light max-w-2xl mx-auto leading-relaxed py-5 mb-5 relative z-10">
          It’s the gap between <span className="text-founderin-mint md:text-founderin-dark">what you’ve built</span><br />and <span className="text-founderin-mint md:text-founderin-dark">what the world sees</span>
        </p>
