...
export default function PitchShoot() {
        ...
        <SectionWrapper className="py-32">
          <div className="max-w-md mx-auto text-center">
            ...
            <p className="text-founderin-dark/70 mb-6">
              Your information has been saved. Click the button below to
              complete your payment and secure your slot.
            </p>
            <Button
              size="lg"
              fullWidth
              ...
              onClick={() =>
                handlePaymentRedirect(submissionId, formState.email)
              }
            >
              Continue to Payment
            </Button>
  ...
  return (
    <div className="min-h-screen bg-founderin-white font-sans text-founderin-dark">
      ...
      >
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          ...
          <p className="text-lg md:text-xl text-founderin-dark/80 max-w-2xl mx-auto leading-relaxed mb-10 font-medium">
            A guided 2-hour session where we clarify your story, rebuild your
            pitch, and record a high-signal founder video you can immediately
            use with investors, partners, and the market.
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="relative group cursor-pointer">
              <img
                src="/team/founderin-scene-sm.jpg"
                alt="FounderIn team in action"
                className="w-full h-auto rounded-xl shadow-lg transition-all duration-500 ease-in-out filter grayscale group-hover:grayscale-0 group-hover:scale-105"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </div>
            <div>
              <p className="text-[1.6rem] md:text-[1.9rem] font-bold leading-tight text-founderin-dark">
                This is a{" "}
                <span className="text-founderin-purple">
                  working session with a camera
                </span>{" "}
                where your founder pitch is rebuilt live and recorded.
              </p>
            </div>
          </div>
        </div>
      ...
      <SectionWrapper
        variant="gray"
        className="py-16 md:py-24 bg-founderin-mint"
      >
        <div className="max-w-4xl mx-auto">
          <h2 className="text-[2rem] md:text-[2.5rem] font-acumin-black text-center mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-8 rounded-xl border border-founderin-dark/5 shadow-sm">
              ...
              <h3 className="text-lg font-bold mb-2">
                A clear, reusable founder pitch
              </h3>
              <p className="text-founderin-dark/70 text-sm">
                Distilled down to the core value that matters.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl border border-founderin-dark/5 shadow-sm">
              <div className="w-10 h-10 bg-founderin-purple/10 rounded-full flex items-center justify-center mb-4 text-founderin-purple">
              ...
              <h3 className="text-lg font-bold mb-2">
                A recorded founder pitch video
              </h3>
              <p className="text-founderin-dark/70 text-sm">
                High-signal asset for investors and partners.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl border border-founderin-dark/5 shadow-sm">
              <div className="w-10 h-10 bg-founderin-purple/10 rounded-full flex items-center justify-center mb-4 text-founderin-purple">
              ...
              <p className="text-founderin-dark/70 text-sm">
                Copy you can deploy across decks, websites, and profiles.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8 relative before:absolute before:left-[19px] before:top-4 before:bottom-4 before:w-[2px] before:bg-founderin-dark/10">
            <div className="relative flex gap-6 items-start">
              <div className="w-10 h-10 rounded-full bg-founderin-dark text-white flex items-center justify-center flex-shrink-0 relative z-10 font-bold">
                1
              </div>
              <div className="pt-2">
                <h3 className="text-xl font-bold mb-1">
                  Submit the short intent form
                </h3>
                <p className="text-founderin-dark/70">
                  Tell us what you're building so we can prepare.
                </p>
              </div>
            </div>
            <div className="relative flex gap-6 items-start">
            ...
            <div className="relative flex gap-6 items-start">
              ...
              <div className="pt-2">
                <h3 className="text-xl font-bold mb-1">
                  Receive onboarding & confirmation
                </h3>
                <p className="text-founderin-dark/70">
                  We'll send you prep materials immediately.
                </p>
              </div>
            </div>
          </div>
          <div className="mt-10 p-4 bg-founderin-purple/5 rounded-lg border border-founderin-purple/10 flex items-center gap-3 justify-center text-center">
            ...
            <p className="text-sm font-semibold text-founderin-dark/80">
              Note: Founder Pitch Shoots run on{" "}
              <span className="text-founderin-purple font-bold">
                Fridays only
              </span>{" "}
      ...
      <SectionWrapper
        variant="gray"
        className="py-16 md:py-24 bg-founderin-mint/10"
      >
        <div className="max-w-3xl mx-auto">
          <h2 className="text-[2rem] md:text-[2.5rem] font-acumin-black text-center mb-12">
          ...
          <div className="bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-founderin-dark/5 space-y-6 text-lg text-founderin-dark/80 leading-relaxed">
            ...
            <p>So our policy is simple.</p>
            <p>
              If you show up to the session, fully participate, follow the
              process, and apply the narrative and messaging we build together,
              and you still feel you didn't get the clarity or value you
              expected, tell us.
            </p>
            ...
            <p>
              We put this condition in place for a reason. We know this process
              works.
            </p>
            <p>
              What we install during the shoot isn't theory, templates, or
              generic advice. It's extracted directly from your product, your
              thinking, and your ambition, then rebuilt into a founder pitch the
              market can understand.
            </p>
            <p>
              The only variable we don't control is participation. When founders
              show up fully, the outcome is clarity, confidence, and a story
              that finally lands.
            </p>
            <p className="font-bold text-founderin-dark">
      ...
      >
        <div className="max-w-2xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-xl">
          <h2 className="text-[1.8rem] md:text-[2.2rem] font-acumin-black text-center mb-8">
            Reserve Your Slot
          </h2>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label className="text-sm font-bold text-founderin-dark">
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold text-founderin-dark">
                Do you have a working product or deep prototype?
              </label>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    onChange={(e) =>
                      updateField("preferredFriday", e.target.value)
                    }
                  ...
                  {(() => {
                    if (!formState.preferredFriday) {
                      return (
                        <p className="text-xs text-founderin-dark/50 mt-1">
                          Sessions are primarily held on Fridays.
                        </p>
                      );
                    }
                    const [y, m, d] = formState.preferredFriday
                      .split("-")
                      .map(Number);
                    ...
                    if (isFriday) {
                      return (
                        <p className="text-xs text-founderin-dark/50 mt-1">
                          Excellent choice. Fridays are our standard session
                          day.
                        </p>
                      );
                    } else {
                      return (
                        <p className="text-xs text-amber-600 font-medium mt-1">
                          Note: Sessions are typically on Fridays. We'll follow
                          up to coordinate this special request.
                        </p>
                      );
                    }
                  })()}
            ...
            <div className="pt-4 space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-center gap-2 text-founderin-dark/50 text-xs">
                  ...
                  <p>
                    We review each request to ensure fit. Your slot is confirmed
                    after payment.
                  </p>
                </div>
